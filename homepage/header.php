        ...
        <div class="collapse navbar-collapse justify-content-center mt-3" id="navbarToggle">
            <ul class="navbar-nav">
                <li class="nav-item" data-aos="fade-down" data-aos-delay="500">
                    <a class="nav-link nav-color <?= (Url::check() == '') ? 'active' : ''?>" href="<?= BASE_URL?>">Home
                    </a>
                </li>
                <li class="nav-item" data-aos="fade-down" data-aos-delay="600">
                    <a class="nav-link nav-color <?= (Url::check() == 'products') ? 'active' : ''?> "
                        href="<?= BASE_URL?>/products">Product</a>
                </li>
                <li class="nav-item" data-aos="fade-down" data-aos-delay="700">
                    <a class="nav-link nav-color  <?= (Url::check() == 'contact') ? 'active' : ''?>"
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item" data-aos="fade-down" data-aos-delay="1000">
                    <a class="nav-link nav-color  <?= (Url::check() == 'blog') ? 'active' : ''?>"
                        href="<?= BASE_URL?>/blog">Blog</a>
                </li>
                <li class="nav-item" data-aos="fade-down" data-aos-delay="1100">
                    <a class="nav-link nav-color  <?= (Url::check() == 'about') ? 'active' : ''?>"
